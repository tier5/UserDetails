...
User Details, records the info of all the users that register. After registering they can edit their details.
...
- Clone Repo --> https://github.com/tier5/UserDetails.git
